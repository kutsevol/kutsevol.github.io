...
последующих статьях будут за основу взято *Linux-системы*.
...
*В этом цикле статей будет за основу взята 3 версия **Python**.*
...
Попробуем написать первую программу на **Python** - *hello_world*.
...
функция, которая принимает выражения для последующего вывода на экран.
...
сохранять программный код в файле и запускать уже файл.
...
Есть несколько способов создать **Python** файл.
